"""
Django settings for cold_wind_42208 project.
...
ROOT_URLCONF = 'cold_wind_42208.urls'
...
WSGI_APPLICATION = 'cold_wind_42208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_wind_42208 API",
    "DESCRIPTION": "API documentation for cold_wind_42208 App",
    "VERSION": "v1",
}
